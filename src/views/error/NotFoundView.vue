...
<template>
  <div class="error-view">
    <div class="error-view__content">
      <IconBase name="warning" :size="120" color="rgb(var(--color-warning))" />
      <h1 class="error-view__title">404</h1>
      <h2 class="error-view__subtitle">Page Not Found</h2>
